...
Parser_Tester::Parser_Tester(QObject *parent): QObject(parent)
{

}

void Parser_Tester::ReportTreeParseTest()
{
...
void Parser_Tester::ReportTagParseTest()
{
    qtreports::detail::Parser parser;
